x <- read.table("zosterops_repeatmodeler_genomic.blast", sep="\t", stringsAsFactors=F)

# read in reference index to make sure bed file doesn't overlap edges
fai <- read.table("Zost_lateralis_ref.fa.fai", sep="\t", stringsAsFactors=F)
