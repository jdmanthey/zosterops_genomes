...
/lustre/work/jmanthey/gatk-4.1.0.0/gatk CleanSam -I /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}.bam -O /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned.bam

rm /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}.bam

/lustre/work/jmanthey/gatk-4.1.0.0/gatk SortSam -I /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned.bam -O /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned_sorted.bam --SORT_ORDER coordinate

rm /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned.bam

/lustre/work/jmanthey/gatk-4.1.0.0/gatk AddOrReplaceReadGroups -I /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned_sorted.bam -O /lustre/scratch/jmanthey/10_zosterops/01_bam_files/${SGE_TASK_ID}_cleaned_sorted_rg.bam --RGLB 1 --RGPL illumina --RGPU unit1 --RGSM ${SGE_TASK_ID}
